...
scheduler_events = {
	...
	"00 08 * * *": [
    		         "erpnext.selling.doctype.sales_order.sales_order.scheduler_method"
        ],
        "05 08 * * *": [
              		 "erpnext.selling.doctype.sales_order.sales_order.update_date"
        ],
	"00 17 * * *": [
                         "erpnext.selling.doctype.sales_order.sales_order.scheduler_method"
	],
   ...
   #    for Biometric  purpose crons
# "58 23 * * *":  [
 #               "erpnext.hr.doctype.biometric_attendance.biometric_attendance.scheduler_method"
  #      ],
   #     "00 01 * * * *":        [
    #                    "erpnext.hr.doctype.log_data.log_data.scheduler_method"
     #   ],
      #  "00 13 * * *":  [
       #                 "erpnext.hr.doctype.log_data.log_data.scheduler_method"
       # ],
